        ...
        <el-col :lg="6" :md="6" :sm="6" :xs="3">
          <el-form ref="form" :model="form" label-width="90px">
            ...
            <el-form-item label="Appid">
              ...
              <el-button type="text" @click="generateAppid">生成</el-button>
            </el-form-item>
            <el-form-item label="Appekey">
              <span>{{ form.appkey }}</span>
              <el-button type="text" @click="randomString">生成</el-button>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submit() {
      this.$api.post("/business/saveData", this.form, (rep) => {
        if (rep.status >= 200 && rep.status < 300) {
          if (rep.data.msg == '添加成功') {
